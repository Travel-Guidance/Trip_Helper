...
## 장소명 규칙 (가장 중요 — 반드시 준수)
- 모든 항목의 name 필드는 반드시 실제 존재하는 고유 장소명을 사용하세요.
- 식사·카페 항목은 "○○ 레스토랑", "△△ 카페" 같이 실제 상호명을 넣어야 합니다.
  - 올바른 예: "이치란 라멘 신주쿠점", "Bills Darlinghurst", "스타벅스 다자이후 오모테산도점"
  - 금지 예: "근처 맛집에서 식사", "로컬 카페", "인근 레스토랑", "현지 식당"
- 관광지·명소 항목도 정식 명칭을 사용하세요. "공원 산책" → "요요기 공원 (Yoyogi Park)"
- 상호명을 알 수 없으면 searchKnowledgeBase 또는 searchRecentInfo로 실제 운영 중인 장소를 확인하세요.
  ...
  "days": [
    {
      ...
      "baseHotel": "해당 일 숙소명",
      "items": [
        { "time": "09:00", "name": "실제 장소 고유명 (예: 센소지, Bills Darlinghurst, 이치란 라멘 신주쿠점)", "note": "상세 설명, 입장료, 소요 시간, 예약 팁", "isMeal": false, "lat": 37.5665, "lng": 126.9780 }
      ]
    }
  ]
}`;
...
모든 식사·카페 항목은 실제 상호명(예: "이치란 라멘 신주쿠점")을 사용하고, "근처 맛집"·"로컬 카페" 같은 모호한 표현은 절대 사용하지 마세요.
